...
function DashboardPageInner() {
      ...
      <div className="space-y-6 pb-6">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-gray-500 mt-1">
              Track your candidate's admission lifecycle steps.
            </p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          ...
          <MetricCard
            title="Active Offers"
            value="0 Pending"
            sub="Awaiting merit list release"
            icon={Award}
    ...
    return (
      <div className="space-y-6 pb-6">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-1">
            Walk-in visitors registry and inquiry logging.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <MetricCard
            ...
            value={getKPIValue('reception.kpi.walkins', 12)}
            sub="Logged visitors"
            icon={Users}
              ...
              <tbody>
                <tr className="border-b border-gray-50 text-gray-700">
                  ...
                  <td className="py-3 text-right">
                    <button className="text-primary hover:underline font-bold">Assign Lead</button>
                  </td>
                </tr>
    ...
    return (
      <div className="space-y-6 pb-6">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-1">
            Lead assignments, follow-ups call scheduling, and conversion ratios.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <MetricCard
            ...
            value={getKPIValue('principal.kpi.conversions', '48%')}
            sub="Inquiry to Application"
            icon={TrendingUp}
            color="text-emerald-600 bg-emerald-50"
          />
        </div>
        ...
        <div className="bg-white p-5 rounded-2xl border border-gray-100 shadow-sm">
          ...
          <div className="space-y-3">
            {(engineTasks && engineTasks.length > 0
              ? engineTasks.map((t: any) => ({
                  name: t.title,
              ...
              : [
                  {
                    name: 'Amit Verma',
                    grade: 'Grade 5',
                    details: 'Waiting for follow-up callback',
                  },
              ...
              <div
                key={i}
                className="p-4 rounded-xl border border-solid border-gray-100 flex items-center justify-between text-xs"
              >
                <div>
                  <p className="font-bold text-gray-900">
                    {lead.name} ({lead.grade})
                  </p>
    ...
    return (
      <div className="space-y-6 pb-6">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-1">
            Manage entrance test registries, panels feedback, and generate merit lists.
          </p>
        </div>
            ...
            <div className="p-4 rounded-xl border border-solid border-gray-100 flex flex-col justify-between h-36">
              <div>
                ...
                <p className="text-[10px] text-gray-500 mt-1">
                  Computes scores for 45 tested applicants
                </p>
              </div>
    ...
    return (
      <div className="space-y-6 pb-6">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-1">
            Merit list approvals, offer triggers, and admissions override dashboard.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          ...
          <MetricCard
            ...
            value={getKPIValue('admissions.kpi.verified', 15)}
          ...
          <MetricCard
            ...
            value={getKPIValue('principal.kpi.conversions', '62%')}
          ...
          <MetricCard
            ...
            value={getKPIValue('admissions.kpi.enrolled', 42)}
          ...
          <div className="space-y-3">
            <div className="p-4 rounded-xl border border-solid border-gray-100 flex items-center justify-between text-xs">
              <div>
                ...
                <p className="text-[10px] text-gray-500 mt-0.5">
                  Completed by Exam Cell: 18 Candidates
                </p>
              </div>
            ...
            <div className="p-4 rounded-xl border border-solid border-gray-100 flex items-center justify-between text-xs">
              <div>
                ...
                <p className="text-[10px] text-gray-500 mt-0.5">
                  Pending dispatch to 8 approved applicants
                </p>
              </div>
              <button className="px-4 py-2 rounded-xl bg-indigo-600 text-white font-bold hover:bg-indigo-700 shadow-sm transition-colors">
                Trigger Offers
    ...
    return (
      <div className="space-y-6 pb-6">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-1">
            Verify payment receipts, allocate scholarships, and reconcile admissions revenue.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          <MetricCard
            ...
            value={getKPIValue('finance.kpi.ledger', 8) + ' Transactions'}
          ...
          <MetricCard
            ...
            value={DashboardMapper.formatRupee(
              Number(getKPIValue('finance.kpi.collected', 180000)),
            )}
          ...
          <MetricCard
            ...
            value={DashboardMapper.formatRupee(Number(getKPIValue('finance.kpi.pending', 210000)))}
            sub="Unpaid draft offers"
            icon={DollarSign}
            color="text-amber-600 bg-amber-50"
          />
          <MetricCard
  ...
  const kpis = [
    {
      ...
      value: getKPIValue('reception.kpi.walkins', '142'),
      sub: 'CRM Inbound leads',
      icon: Users,
    ...
    },
    {
      ...
      value: DashboardMapper.formatRupee(Number(getKPIValue('finance.kpi.collected', 452000))),
      sub: 'Admission fees received',
      icon: DollarSign,
  ...
  const quickActions = [
    ...
    },
    {
      ...
      href: '/app/admissions/review',
      icon: CheckSquare,
      color: 'bg-green-50 text-green-600 border-green-100',
    },
    {
      label: 'Schedule Exam',
      href: '/app/admissions/exams',
      icon: Calendar,
      color: 'bg-indigo-50 text-indigo-600 border-indigo-100',
    },
    {
      label: 'Collect Fee',
      href: '/app/admissions/fees',
      icon: CreditCard,
      color: 'bg-amber-50 text-amber-600 border-amber-100',
    },
    {
      label: 'Enroll Handoff',
      href: '/app/admissions/enrollment',
      icon: Award,
  ...
  return (
    <div className="space-y-6 pb-6">
      <div>
        ...
        <p className="text-sm text-gray-500 mt-1">
          Real-time indicators across the admission funnel.
        </p>
      </div>
          ...
          {[
            {
              label: 'Doc Reviews',
              count: '14 pending',
              color: 'border-l-indigo-400 bg-indigo-50/20',
            },
            { label: 'Exam Marking', count: '7 pending', color: 'border-l-blue-400 bg-blue-50/20' },
            {
              label: 'Interview Scores',
              count: '5 pending',
              color: 'border-l-purple-400 bg-purple-50/20',
            },
            {
              label: 'Merit List Desk',
              count: 'Ready to generate',
              color: 'border-l-pink-400 bg-pink-50/20',
            },
            {
            ...
            {
              label: 'Enroll Handoff',
              color: 'border-l-green-400 bg-green-50/20',
              count: '3 pending',
            },
          ].map((stage, i) => (
