...
export function ProductivityPanel({ isOpen, onClose }: ProductivityPanelProps) {
  ...
  const noteKey = `edutrack.user.${userId}.quick_note`;
  const tasksKey = `edutrack.user.${userId}.tasks`;
  ...
  // User-scoped Local Storage Note State
  ...
  // User-scoped Local Storage Tasks State
          ...
          >
            ...
            <div className="p-4 border-b border-border/80 flex items-center justify-between bg-gray-50/50 dark:bg-muted/10">
              <div className="flex items-center gap-2">
                ...
                <span className="font-black text-sm uppercase tracking-wider text-gray-900 dark:text-gray-100">
            ...
            <div className="p-4 border-b border-border/60 space-y-3">
              ...
              <div className="flex items-center gap-1.5 flex-wrap">
                <span className="text-[10px] font-black uppercase text-gray-400 mr-1.5">
                  Pinned:
                </span>
              ...
              {activeTab === 'tasks' && (
                <div className="space-y-4">
                  <form onSubmit={handleAddTask} className="flex gap-2">
                    ...
                    <button
                      type="submit"
                      className="px-3.5 py-1.5 bg-primary text-white font-bold rounded-xl text-xs hover:bg-primary/95"
                    >
                      Add
                    </button>
                  </form>
                    ...
                    {tasks.map((task) => (
                      ...
                      >
                        <div className="flex items-center gap-2.5">
                          ...
                          <span className={task.done ? 'line-through font-medium' : 'font-bold'}>
                            {task.text}
                          </span>
                        </div>
                        <button
              ...
              {activeTab === 'notes' && (
                <div className="h-full flex flex-col space-y-2">
                  <p className="text-[10px] text-gray-400 font-bold uppercase tracking-wider">
                    Scratchpad notes (Saved automatically)
                  </p>
                  <textarea
                    value={note}
              ...
              {activeTab === 'recents' && (
                <div className="space-y-3.5">
                  {[
                    ...
                    {
                      action: 'Uploaded checklist Grade 1',
                      role: 'Receptionist',
                      time: '35 mins ago',
                    },
                    {
                      action: 'Approved merit list Grade 11',
                      role: 'Principal',
                      time: '1 hour ago',
                    },
                  ].map((act, i) => (
