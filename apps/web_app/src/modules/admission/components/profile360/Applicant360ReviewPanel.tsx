...
export function Applicant360ReviewPanel({ applicationId }: Applicant360ReviewPanelProps) {
  ...
  const canApprove =
    AdmissionPermissions.isPrincipal(permCtx) ||
    ...
    <div className="space-y-4">
      <div className="p-4 border rounded-xl bg-gray-50/50 space-y-2">
        ...
        <p className="text-xs text-gray-500 leading-relaxed">
          Record eligibility notes, committee decision, approval or rejection rationale. Actions
          update the centralized workflow orchestrator.
        </p>
      </div>
      ...
      <div className="flex flex-wrap items-center gap-2">
        ...
        <Button
          ...
          className="gap-1 bg-emerald-50 text-emerald-700 border border-emerald-200 hover:bg-emerald-100"
        >
          <CheckCircle2 className="w-3.5 h-3.5" />
          Formal Decision Desk
        </Button>
      </div>
