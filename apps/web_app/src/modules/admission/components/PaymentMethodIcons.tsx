...
export const ICONS = [
  ...
  },
  {
    ...
    src: visaImg,
    label: 'Visa Card',
    tooltip: 'Visa Debit/Credit Cards',
  },
  {
    id: 'MASTERCARD',
    category: 'CARD',
    ...
    src: mastercardImg,
    label: 'Mastercard',
    tooltip: 'Mastercard Debit/Credit Cards',
  },
  {
    id: 'RUPAY',
    category: 'CARD',
              ...
              <Tooltip key={item.id}>
                <TooltipTrigger asChild>
                  <motion.div
                    ...
                    className={`relative transition-all duration-300 flex items-center justify-center cursor-pointer shrink-0 p-3 rounded-2xl ${
                      isSelected
                  ...
                  >
                    <div
                      className={`transition-all duration-500 ${isSelected ? 'opacity-100' : 'opacity-60 saturate-100 brightness-110'}`}
                    >
                      {item.src ? (
