...
export const FinanceDashboard = () => {
  ...
  const kpiCards: KPI[] = [
    // Collections
    {
      ...
      value: fmt(kpis.todayCollection ?? 0),
      sub: 'vs yesterday',
      icon: DollarSign,
    ...
    {
      label: 'This Month',
      value: fmt(kpis.monthCollection ?? 0),
      sub: 'current month',
      icon: TrendingUp,
    ...
    // Outstanding
    {
      ...
      sub: `${kpis.pendingCount ?? 0} demands`,
      icon: AlertCircle,
    ...
    {
      label: 'Overdue Fees',
      value: fmt(kpis.overdueAmount ?? 0),
      sub: 'past due date',
      icon: AlertTriangle,
    ...
    },
    {
      ...
      value: String(kpis.activeStructuresCount ?? 0),
      sub: 'fee templates',
      icon: Layers,
  ...
  const quickActions = [
    {
      ...
      icon: Plus,
      path: '/app/finance/structures',
      color: 'from-emerald-500 to-teal-600',
    },
    {
      label: 'Generate Demand',
      icon: PlusCircle,
      path: '/app/finance/demands',
  ...
  return (
    <div className="p-6 md:p-8 space-y-8 text-slate-800 dark:text-slate-100">
      ...
      <div className="flex flex-wrap items-center justify-between gap-4">
        ...
        <button
          onClick={fetchAll}
          className="flex items-center gap-2 px-4 py-2 bg-slate-100 hover:bg-slate-200 dark:bg-white/5 dark:hover:bg-white/10 rounded-xl text-sm font-medium transition-all"
        >
      ...
      <div className={`${GLASS} p-5`}>
        ...
        <div className="grid grid-cols-3 sm:grid-cols-6 gap-3">
          {quickActions.map((a) => (
            ...
            >
              <div
                className={`w-10 h-10 rounded-xl bg-gradient-to-br ${a.color} flex items-center justify-center shadow-md group-hover:shadow-lg transition-shadow`}
              >
