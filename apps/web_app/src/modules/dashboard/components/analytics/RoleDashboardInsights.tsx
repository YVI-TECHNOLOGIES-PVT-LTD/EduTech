  ...
  const buildInsights = () => {
      ...
      return [
        {
          ...
          value: metricVal('walkins'),
          icon: Users,
          accent: 'blue' as const,
          subtext: 'Front desk registrations',
        },
        {
        ...
        {
          label: 'New Inquiries',
          value: metricVal('inquiries'),
          icon: ClipboardList,
          accent: 'purple' as const,
          subtext: 'Logged this session',
        },
      ];
    }
      ...
      return [
        {
          ...
          value: metricVal('leads'),
          icon: Users,
          accent: 'indigo' as const,
          subtext: 'Active funnel entries',
        },
        {
        ...
        {
          label: 'Conversions',
          value: metricVal('conversions'),
          icon: TrendingUp,
          accent: 'blue' as const,
          subtext: 'Lead → Application',
          trend: { direction: 'up' as const, label: 'vs last week' },
        },
      ];
    }
      ...
      return [
        {
          ...
          value: metricVal('reviews'),
          icon: ClipboardList,
          accent: 'amber' as const,
          subtext: 'Applications awaiting',
        },
        {
          ...
          icon: UserCheck,
          accent: 'emerald' as const,
          subtext: 'Documents checked',
        },
        {
          label: 'Documents Pending',
          value: metricVal('documents'),
          icon: AlertTriangle,
          accent: 'rose' as const,
          subtext: 'Incomplete checklists',
        },
      ];
    }
    if (roles.some((r) => ['FINANCE_OFFICER', 'ACCOUNTANT'].includes(r))) {
      return [
        ...
        {
          label: 'Scholarships Queue',
          value: metricVal('scholarship'),
          icon: BarChart3,
          accent: 'purple' as const,
    ...
    if (roles.some((r) => ['PRINCIPAL', 'HOI', 'HEAD_OF_INSTITUTE'].includes(r))) {
      return [
        ...
        },
        {
          ...
          value: metricVal('acceptance'),
          icon: UserCheck,
          accent: 'emerald' as const,
          subtext: 'This intake cycle',
    ...
    if (roles.some((r) => r === 'FACULTY')) {
      return [
        ...
        },
        {
          ...
          value: metricVal('attendance'),
          icon: CalendarCheck,
          accent: 'emerald' as const,
          subtext: 'Sessions marked today',
        },
      ];
    }
