...
export function PublicLayout() {
  ...
  const handleApplyNow = () => navigate('/admission/register');
  ...
  return (
    <div className="min-h-screen bg-background text-foreground font-sans selection:bg-[#E7B76A] selection:text-[#063F40] flex flex-col overflow-x-hidden relative">
      {/* Canonical Top Announcement & Floating Pill Navbar Shell */}
      <div className="bg-[#042A2B] text-white relative z-40">
        <AnnouncementBar onApplyClick={handleApplyNow} />
