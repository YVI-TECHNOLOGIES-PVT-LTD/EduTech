...
export const FormStepper = ({ steps, currentStep }: FormStepperProps) => {
  return (
    <div className="w-full py-4 px-6 bg-card text-card-foreground rounded-2xl border border-border flex items-center justify-between gap-4 mb-6">
...
export const FormFieldWrapper = ({
  ...
  return (
    <div className="flex flex-col gap-1.5 w-full text-left">
      <label className="text-xs font-bold text-foreground tracking-wide select-none">{label}</label>
      {description && (
      ...
      {error && (
        <span className="flex items-center gap-1.5 text-[10px] font-semibold text-destructive animate-in fade-in duration-200">
