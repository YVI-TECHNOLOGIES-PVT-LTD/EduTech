    ...
    <div className="w-full space-y-4">
      ...
      >
        <input
          ...
          className="hidden"
        />
        <div className="w-12 h-12 bg-card rounded-xl shadow-sm border border-border flex items-center justify-center text-primary">
        ...
        <div>
          ...
          <p className="text-[10px] text-muted-foreground mt-1">
            Max size: {maxSizeMB}MB. Supported formats:{' '}
            {accept.map((a) => a.split('/')[1]).join(', ')}
          </p>
        </div>
      </div>
            ...
            >
              <div className="flex items-center gap-3 flex-1 min-w-0">
                ...
                <div className="flex-1 min-w-0">
                  <p className="text-xs font-bold text-foreground truncate">{f.file.name}</p>
