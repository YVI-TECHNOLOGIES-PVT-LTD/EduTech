    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-6 animate-in fade-in duration-300">
      <div className="bg-white rounded-2xl shadow-xl border border-gray-100 max-w-md w-full p-8 text-center">
        ...
        <p className="text-gray-500 mb-6 text-sm leading-relaxed">
          You do not possess the required RBAC credentials to view this page. Please return to the
          dashboard.
        </p>
        <Button onClick={() => navigate('/app')} className="w-full rounded-xl">
          Back to Dashboard
        </Button>
      </div>
    </div>
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-6 animate-in fade-in duration-300">
      <div className="bg-white rounded-2xl shadow-xl border border-gray-100 max-w-md w-full p-8 text-center">
        ...
        <p className="text-gray-500 mb-6 text-sm leading-relaxed">
          The URL path you entered does not map to any active ERP module. Please double check the
          routing path.
        </p>
        <Button onClick={() => navigate('/app')} className="w-full rounded-xl">
          Back to Dashboard
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-6 animate-in fade-in duration-300">
      <div className="bg-white rounded-2xl shadow-xl border border-gray-100 max-w-md w-full p-8 text-center">
        ...
        <p className="text-gray-500 mb-6 text-sm leading-relaxed">
          The backend API returned an internal exception. Please try again or report to support if
          it persists.
        </p>
        <Button onClick={() => navigate('/app')} className="w-full rounded-xl">
          Back to Dashboard
