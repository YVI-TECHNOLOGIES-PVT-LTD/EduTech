    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-6">
      <div className="max-w-md w-full bg-white rounded-3xl shadow-xl shadow-gray-200/50 border border-gray-100 p-8 text-center">
        ...
        <p className="text-gray-500 mb-8">
          Hello, <span className="font-bold text-gray-800">{user?.full_name}</span>. Your account
          registration is complete, but your login access is currently{' '}
          <span className="px-2 py-0.5 bg-amber-100 text-amber-700 rounded text-xs font-bold uppercase tracking-wider">
            {user?.login_status}
          </span>
          .
        </p>
        ...
        <div className="space-y-4">
          <div className="bg-blue-50 border border-blue-100 rounded-2xl p-6 text-left">
            ...
            <p className="text-sm text-blue-700 leading-relaxed">
              A school administrator will review your application and approve your dashboard access.
              You will be able to access all features once your login is{' '}
              <span className="font-bold underline">APPROVED</span>.
            </p>
          </div>
          ...
          {user?.login_decision_reason && user.login_status === 'REJECTED' && (
            <div className="bg-red-50 border border-red-100 rounded-2xl p-6 text-left">
              ...
              <p className="text-sm text-red-700 leading-relaxed">{user.login_decision_reason}</p>
            </div>
          )}
