...
export function ProfileBadge({
  ...
  return (
    <span
      className={`text-[9px] font-bold px-2 py-0.5 rounded-md border uppercase tracking-wider ${styles[type]}`}
    >
      {label}
    </span>
  );
    ...
    <div className="space-y-2">
      {links.map((link, idx) => (
        <a
          key={idx}
          href={link.link}
          className="flex items-center justify-between p-2.5 rounded-xl hover:bg-gray-50 border border-transparent hover:border-gray-100 transition-all"
        >
  ...
  const studentStats = [
    {
      ...
      value: '98.2%',
      trend: '+1.2% this term',
      points: [90, 92, 95, 94, 98],
    },
    {
      label: 'Pending Fees',
      value: '$120.00',
      trend: 'Due by next Monday',
      points: [150, 150, 120, 120, 120],
    },
    {
      label: 'GPA Average',
      value: '3.85 / 4.0',
      trend: '+0.15 grade increase',
      points: [3.5, 3.6, 3.8, 3.7, 3.85],
    },
    {
      label: 'Behavior Rating',
      value: '95 / 100',
      trend: 'Exemplary conduct badge',
      points: [90, 95, 95, 95, 95],
    },
  ];
  ...
  const staffStats = [
    {
      ...
      value: '14 Days',
      trend: '4 Sick leaves remaining',
      points: [15, 15, 14, 14, 14],
    },
    {
      label: 'Pending Approvals',
      value: '3 Requests',
      trend: 'Requires board verify',
      points: [5, 4, 3, 3, 3],
    },
    {
      label: 'Active Timetable',
      value: '24 Hours/wk',
      trend: '6 Classes scheduled',
      points: [20, 24, 24, 24, 24],
    },
    {
      label: 'Active Student Count',
      value: '128 Students',
      trend: '+8 new additions',
      points: [120, 120, 128, 128, 128],
    },
  ];
  ...
  return (
    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
      {activeStats.map((stat, idx) => (
        <div
          key={idx}
          className="p-4 bg-white border border-gray-100 shadow-sm rounded-2xl flex flex-col justify-between"
        >
          <div>
  ...
  if (isStudent) {
    ...
    return (
      <div className="space-y-6">
        ...
        <div className="space-y-3">
          <h4 className="text-xs font-black text-gray-400 uppercase tracking-wider">
            Active Subjects & Term Grades
          </h4>
          <div className="grid sm:grid-cols-2 gap-3">
            {subjects.map((sub, idx) => (
              <div
                key={idx}
                className="flex justify-between items-center p-3.5 bg-white border border-gray-100 rounded-xl shadow-sm"
              >
                <div>
      ...
      <div className="space-y-3">
        ...
        <div className="grid sm:grid-cols-3 gap-3">
          {[
            ...
            <div
              key={idx}
              className="p-3.5 bg-white border border-gray-100 rounded-xl shadow-sm space-y-2"
            >
...
function DocumentsTab() {
  const [docs, setDocs] = useState([
    ...
    {
      name: 'Transfer Certificate copy',
      type: 'Transfer Certificate',
      status: 'Pending',
      date: 'Jan 15, 2026',
    },
    {
      name: 'Government Identity card (Aadhar)',
      type: 'Aadhar',
      status: 'Verified',
      date: 'Jan 12, 2026',
    },
  ...
  const handleUploadDummy = () => {
    ...
    setDocs((prev) => [
      ...prev,
      {
        name: 'New Medical Certificate log',
    ...
    <div className="space-y-6">
      ...
      <div className="grid sm:grid-cols-2 gap-4">
        {docs.map((doc, idx) => (
          <div
            key={idx}
            className="p-4 bg-white border border-gray-100 rounded-2xl shadow-sm flex items-center justify-between"
          >
...
function TimelineTab() {
  const events = [
    {
      title: 'Profile Credentials Initialized',
      desc: 'Security setup by campus registrar',
      time: 'Jan 10, 2026 • 09:12 AM',
    },
    {
      title: 'Admission Record Created',
      desc: 'Import verification status approved',
      time: 'Jan 12, 2026 • 02:44 PM',
    },
    {
      title: 'Profile Security Updates',
      desc: 'Password credentials set by user',
      time: 'Jan 15, 2026 • 10:15 AM',
    },
    {
      title: 'Registration Fee Logged',
      desc: 'Finance verification ledger cleared',
      time: 'Jan 18, 2026 • 04:30 PM',
    },
  ];
...
function ActivityTab() {
  const logs = [
    {
      event: 'Login Session Opened',
      device: 'Chrome / Windows 11',
      location: 'Hyderabad, IN',
      time: 'Today 09:42 AM',
    },
    {
      event: 'Change Password Form opened',
      device: 'Chrome / Windows 11',
      location: 'Hyderabad, IN',
        ...
        <div className="space-y-4">
          <div className="flex justify-between items-start">
            <div>
              ...
              <p className="text-[10px] text-gray-400 mt-0.5">
                Protect account access with custom OTP validation.
              </p>
            </div>
          ...
          <div className="flex justify-between items-start pt-3 border-t border-gray-200">
            <div>
              ...
              <p className="text-[10px] text-gray-400 mt-0.5">
                Recover account credentials securely.
              </p>
            </div>
...
function PreferencesTab() {
  const { theme, setTheme, language, setLanguage, notifications, setNotificationPref } =
    useSettingsStore();
          ...
          <div className="bg-white rounded-3xl p-5 shadow-xl border border-gray-100 space-y-4">
            ...
            <div className="space-y-3">
              <div className="flex justify-between border-b border-gray-50 pb-2">
                ...
                <span className="text-xs font-bold text-navy truncate max-w-[140px]">
                  {user.email}
                </span>
              </div>
              <div className="flex justify-between border-b border-gray-50 pb-2">
          ...
          <div className="bg-white rounded-3xl p-6 shadow-sm border border-gray-100 space-y-6">
            ...
            <AnimatePresence mode="wait">
              ...
              >
                {activeTab === 'overview' && (
                  <div className="grid md:grid-cols-3 gap-6">
                    <div className="md:col-span-2 space-y-6">
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="grid sm:grid-cols-2 gap-4">
                          ...
                          <div className="p-3 bg-gray-50 border border-gray-100 rounded-xl">
                            <p className="text-[10px] font-black text-gray-400 uppercase tracking-wide">
                              {roleDetails.deptLabel}
                            </p>
                            <p className="text-sm font-bold text-navy mt-1">
                              {roleDetails.deptValue}
                            </p>
                          </div>
                        </div>
                      </div>
                      ...
                      {user.permissions && user.permissions.length > 0 && (
                        <div className="bg-gray-50 rounded-2xl p-4 border border-gray-100">
                          <h3 className="text-xs font-black text-gray-505 uppercase tracking-wide mb-3">
                          ...
                          <div className="flex flex-wrap gap-1.5">
                            {user.permissions.slice(0, 10).map((perm) => (
                              <span
                                key={perm}
                                className="bg-white border border-gray-200 text-gray-600 text-[9px] font-bold px-2 py-0.5 rounded-md"
                              >
                                {perm}
                              </span>
                            ))}
                    ...
                    <div className="md:col-span-1 space-y-6 border-t md:border-t-0 md:border-l border-gray-100 pt-6 md:pt-0 md:pl-6">
                      <div>
                        <h3 className="text-xs font-black text-navy uppercase tracking-wider mb-3">
                          Admissions Support
                        </h3>
                        <ProfileQuickLinks />
                      </div>
                      <div className="p-4 bg-primary/5 rounded-2xl border border-primary/10">
                        ...
                        <p className="text-[10px] text-gray-600 mt-1 leading-relaxed">
                          Keep preferences and time zones aligned to stay updated with campus
                          notices.
                        </p>
                      </div>
                    </div>
                ...
                {activeTab === 'academic' && (
                  <AcademicTab role={primaryRole} details={roleDetails} />
                )}
                {activeTab === 'documents' && <DocumentsTab />}
                {activeTab === 'timeline' && <TimelineTab />}
                {activeTab === 'activity' && <ActivityTab />}
                {activeTab === 'security' && (
                  <SecurityTab onSuccess={() => setActiveTab('overview')} />
                )}
                  ...
                  <div className="max-w-md space-y-5">
                    ...
                    <div>
                      ...
                      <p className="text-[10px] text-gray-400 mt-1">
                        Email cannot be modified online. Contact IT team.
                      </p>
                    </div>
                    <button
                      id="profile-save"
