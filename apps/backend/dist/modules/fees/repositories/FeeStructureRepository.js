...
exports.FeeStructureRepository = void 0;
...
class FeeStructureRepository {
     ...
     */
    static async getStructureAggregate(params) {
        ...
        const { data: structures, error: structErr } = await supabase_1.supabase
        ...
        const { data: installments, error: instErr } = await supabase_1.supabase
...
exports.FeeStructureRepository = FeeStructureRepository;
