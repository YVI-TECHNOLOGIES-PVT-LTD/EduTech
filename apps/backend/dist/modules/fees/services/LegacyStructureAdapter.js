...
exports.LegacyStructureAdapter = void 0;
...
class LegacyStructureAdapter {
     ...
     */
    static async mapLegacyToFinanceStructure(legacyStructureId) {
        // 1. Fetch details of the legacy structure
        const { data: legacy, error: legacyErr } = await supabase_1.supabase
        ...
        const { data: mapping, error: mapErr } = await supabase_1.supabase
...
exports.LegacyStructureAdapter = LegacyStructureAdapter;
