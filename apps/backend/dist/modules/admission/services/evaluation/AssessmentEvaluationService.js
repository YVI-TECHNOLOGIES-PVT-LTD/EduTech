...
exports.AssessmentEvaluationService = void 0;
const BaseService_1 = require("../BaseService");
const supabase_1 = require("../../../../config/supabase");
class MCQEvaluator {
    evaluate(response, question, options) {
...
class AssessmentEvaluationService extends BaseService_1.BaseService {
    ...
    async evaluateAttempt(attemptId) {
        ...
        const { data: snapshotQuestions, error: qErr } = await supabase_1.supabase
        ...
        const { data: responses, error: rErr } = await supabase_1.supabase
...
exports.AssessmentEvaluationService = AssessmentEvaluationService;
