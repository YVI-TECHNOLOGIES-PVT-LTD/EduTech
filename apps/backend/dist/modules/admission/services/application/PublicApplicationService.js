...
class PublicApplicationService {
    ...
    async applyAsAuthenticatedParent(userId, email, payload, correlationId) {
        const targetSchoolId = payload.schoolId || payload.school_id || '00000000-0000-0000-0000-000000000000';
    ...
    static async apply(payload) {
        const { email, parent_email, password, parent_password, fullName, parent_name, schoolId, school_id, } = payload;
