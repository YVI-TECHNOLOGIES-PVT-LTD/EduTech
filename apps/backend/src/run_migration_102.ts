...
async function runMigration() {
    console.log('--- Applying RBAC Mapping 102 ---');
    const sqlPath = path.join(__dirname, '../database/migrations/102_admission_assessment_rbac.sql');
    ...
    if (error) {
        ...
        console.log('✅ RBAC Seeds 102 Applied Successfully!');
