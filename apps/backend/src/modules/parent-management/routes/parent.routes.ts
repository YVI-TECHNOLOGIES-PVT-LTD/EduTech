...
parentRouter.get(
  '/dashboard',
  checkPermission(ParentPolicy.canView()),
  ParentAnalyticsController.getDashboard,
);
...
parentRouter.post(
  '/',
  checkPermission(ParentPolicy.canCreate()),
  checkIdempotency,
...
parentRouter.get(
  '/:id/timeline',
  checkPermission(ParentPolicy.canView()),
  ParentAnalyticsController.getTimeline,
);

// Child Resources: Student Linkage
parentRouter.post(
  '/:id/students',
  checkPermission(ParentPolicy.canManageStudents()),
  checkIdempotency,
  ParentStudentController.linkStudent,
);
parentRouter.get(
  '/:id/students',
  checkPermission(ParentPolicy.canView()),
  ParentStudentController.getStudents,
);
parentRouter.delete(
  '/:id/students/:studentId',
  checkPermission(ParentPolicy.canManageStudents()),
  ParentStudentController.unlinkStudent,
);
