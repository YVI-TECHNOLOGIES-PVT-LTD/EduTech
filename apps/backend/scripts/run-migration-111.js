...
async function main() {
    console.log("Applying migration 111_expand_question_bank.sql...");
    const sqlPath = path.join(__dirname, '../database/migrations/111_expand_question_bank.sql');
    ...
    console.log("✅ Migration 111 successfully applied!");
}
