$sqlFile = "c:\Users\DELL\OneDrive\Desktop\School_Management_System\backend\database\migrations\120_attendance_engine.sql"
...
Write-Host "✅ Migration 120 successfully applied via PowerShell RPC!"
