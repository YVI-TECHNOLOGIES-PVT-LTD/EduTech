...
async function main() {
    console.log("Applying migration 120_attendance_engine.sql...");
    const sqlPath = path.join(__dirname, '../database/migrations/120_attendance_engine.sql');
    ...
    console.log("✅ Migration 120 successfully applied!");
}
