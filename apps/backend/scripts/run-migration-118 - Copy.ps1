$sqlFile = "c:\Users\DELL\OneDrive\Desktop\School_Management_System\backend\database\migrations\118_assessment_analytics_engine.sql"
...
Write-Host "✅ Migration 118 successfully applied via PowerShell RPC!"
