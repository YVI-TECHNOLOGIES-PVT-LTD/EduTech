$sqlFile = "c:\Users\DELL\OneDrive\Desktop\School_Management_System\backend\database\migrations\114_assessment_paper_generator.sql"
...
Write-Host "✅ Migration 114 successfully applied via PowerShell RPC!"
