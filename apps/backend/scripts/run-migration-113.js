...
async function main() {
    console.log("Applying migration 113_assessment_template_engine.sql...");
    const sqlPath = path.join(__dirname, '../database/migrations/113_assessment_template_engine.sql');
    ...
    console.log("✅ Migration 113 successfully applied!");
}
