...
async function main() {
    console.log("Applying migration 116_assessment_evaluation_engine.sql...");
    const sqlPath = path.join(__dirname, '../database/migrations/116_assessment_evaluation_engine.sql');
    ...
    console.log("✅ Migration 116 successfully applied!");
}
