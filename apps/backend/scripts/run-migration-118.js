...
async function main() {
    console.log("Applying migration 118_assessment_analytics_engine.sql...");
    const sqlPath = path.join(__dirname, '../database/migrations/118_assessment_analytics_engine.sql');
    ...
    console.log("✅ Migration 118 successfully applied!");
}
