$sqlFile = "c:\Users\DELL\OneDrive\Desktop\School_Management_System\backend\database\migrations\117_assessment_result_engine.sql"
...
Write-Host "✅ Migration 117 successfully applied via PowerShell RPC!"
