...
async function main() {
    console.log("Applying migration 117_assessment_result_engine.sql...");
    const sqlPath = path.join(__dirname, '../database/migrations/117_assessment_result_engine.sql');
    ...
    console.log("✅ Migration 117 successfully applied!");
}
