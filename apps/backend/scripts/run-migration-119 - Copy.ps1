$sqlFile = "c:\Users\DELL\OneDrive\Desktop\School_Management_System\backend\database\migrations\119_academic_records_engine.sql"
...
Write-Host "✅ Migration 119 successfully applied via PowerShell RPC!"
