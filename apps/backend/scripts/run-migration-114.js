...
async function main() {
    console.log("Applying migration 114_assessment_paper_generator.sql...");
    const sqlPath = path.join(__dirname, '../database/migrations/114_assessment_paper_generator.sql');
    ...
    console.log("✅ Migration 114 successfully applied!");
}
